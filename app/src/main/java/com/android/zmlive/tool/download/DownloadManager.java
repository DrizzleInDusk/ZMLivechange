...
public final class DownloadManager {
    ...
    public synchronized void startDownload(String url,String songid,String musicpic, String label, String savePath,
        ...
        if (downloadInfo == null) {
            ...
            downloadInfo.setMusicpic(musicpic);
            downloadInfo.setSongid(songid);
