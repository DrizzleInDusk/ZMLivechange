package com.android.zmlive.session;
...
import com.android.zmlive.session.action.AVChatAction;
import com.android.zmlive.session.action.CustomAttachParser;
import com.android.zmlive.session.action.CustomAttachment;
import com.android.zmlive.session.action.FileAction;
import com.android.zmlive.session.action.GuessAction;
import com.android.zmlive.session.action.GuessAttachment;
import com.android.zmlive.session.action.RTSAction;
import com.android.zmlive.session.action.RTSAttachment;
import com.android.zmlive.session.action.SnapChatAction;
import com.android.zmlive.session.action.SnapChatAttachment;
import com.android.zmlive.session.action.StickerAttachment;
import com.android.zmlive.session.action.TipAction;
import com.android.zmlive.session.activity.MessageHistoryActivity;
import com.android.zmlive.session.activity.MessageInfoActivity;
import com.android.zmlive.session.search.SearchMessageActivity;
import com.android.zmlive.session.viewholder.MsgViewHolderAVChat;
import com.android.zmlive.session.viewholder.MsgViewHolderDefCustom;
import com.android.zmlive.session.viewholder.MsgViewHolderFile;
import com.android.zmlive.session.viewholder.MsgViewHolderGuess;
import com.android.zmlive.session.viewholder.MsgViewHolderRTS;
import com.android.zmlive.session.viewholder.MsgViewHolderSnapChat;
import com.android.zmlive.session.viewholder.MsgViewHolderSticker;
import com.android.zmlive.session.viewholder.MsgViewHolderTip;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/mipmap/bk"
