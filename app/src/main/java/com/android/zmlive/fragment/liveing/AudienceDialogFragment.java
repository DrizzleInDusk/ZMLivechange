...
/***
 *
 * 这是个全屏dailogFragment，他的内部有一个pager
 ...
 *
 */
public class AudienceDialogFragment extends DialogFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentPagerAdapter(getChildFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                if(position == 0){
                    return new AudienceEmptyFragment();/*返回空界面的fragment*/
                }else if (position == 1){
                    return audienceFragment=new AudienceFragment();/*返回交互界面的fragment*/
                }
                return null;
            }
            @Override
