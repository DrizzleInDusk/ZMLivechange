...
import com.android.zmlive.session.SessionHelper;
...
import com.android.zmlive.session.reminder.ReminderManager;
 ...
 */
public class MesssxFragment extends TabFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        notifyBar = inflater.inflate(R.layout.fragment_sixin, container, false);
        return notifyBar;
    }
    ...
    private void onLogout() {
        ...
        ActivityJumpControl.getInstance(getActivity()).gotoChooseLoginActivity();
        ActivityJumpControl.getInstance(getActivity()).popAllActivity();
        getActivity().finish();
    }
